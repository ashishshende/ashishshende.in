...
import { Download, Code, Database, Server, GitBranch, Settings, Zap, Cpu, Brain, Bot } from 'lucide-react';
...
export function HeroSection() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative pt-16 overflow-hidden" aria-label="Hero section">
      {/* Background Video */}
      <video
        autoPlay
        muted
        ...
        <div className="grid xl:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up xl:col-span-1 col-span-full">
            <div className="space-y-4">
              ...
              <p className="text-xl sm:text-2xl lg:text-3xl text-white h-8 sm:h-10 lg:h-12 flex items-center" role="status" aria-live="polite">
                <span>
                  {displayText}
                </span>
            ...
            {/* Tech Stack Icons */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4" role="list" aria-label="Technical skills">
              <div className="flex items-center space-x-2 text-green-400" role="listitem">
                <Code className="w-5 h-5 sm:w-6 sm:h-6" aria-hidden="true" />
              ...
              <div className="flex items-center space-x-2 text-red-400" role="listitem">
                <Bot className="w-5 h-5 sm:w-6 sm:h-6" aria-hidden="true" />
                <span className="font-medium text-sm sm:text-base">Python</span>
              </div>
              <div className="flex items-center space-x-2 text-orange-400" role="listitem">
                <GitBranch className="w-5 h-5 sm:w-6 sm:h-6" aria-hidden="true" />
                <span className="font-medium text-sm sm:text-base">Git/CI-CD</span>
              </div>
              <div className="flex items-center space-x-2 text-cyan-400" role="listitem">
                <Cpu className="w-5 h-5 sm:w-6 sm:h-6" aria-hidden="true" />
                <span className="font-medium text-sm sm:text-base">Docker/K8s</span>
              </div>
              <div className="flex items-center space-x-2 text-pink-400" role="listitem">
                <Brain className="w-5 h-5 sm:w-6 sm:h-6" aria-hidden="true" />
                <span className="font-medium text-sm sm:text-base">AI/ML</span>
              </div>
              <div className="flex items-center space-x-2 text-yellow-400" role="listitem">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="group" aria-label="Download resume">
          ...
          <div className="relative animate-fade-in-right mt-8 lg:mt-0 hidden xl:block" aria-hidden="true">
